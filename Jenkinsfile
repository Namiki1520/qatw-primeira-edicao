...
//                 sh "docker run --rm -v \"\$(pwd):/workspace\" -w /workspace playwright-node-java-v1-noble sh -c 'ls -la && test -f package.json && npm install || { echo \"package.json not found\"; exit 1; }'"
//             }
//         }
